 ...
 *
 * Annotations are consumed by @leplusorg/catchme-provider-testkit:
 *   // @throws  <typeId>            marks the throw site to analyse
 *   // @caught  [definite|possible] the expected handler
 *   // @escapes                     expected to leave the method
